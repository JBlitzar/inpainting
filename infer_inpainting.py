...
import torch
from inpainting_model import CelebAUnetv2,box_out, Autoencoder_CAE, black_out_random_rectangle, Autoencoder_CAEv2, Autoencoder_CAEv3, CelebACAE, CelebACAEv2, black_out_random_rectangle_centered
import pickle
...
def reload_model(_=None):
    global net
    PATH = 'celebaUnetv2.pth'  # celebaCAE.pth'  # v1
    net = CelebAUnetv2()
